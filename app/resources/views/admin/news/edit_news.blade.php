...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/news')}}">Tin ATTP</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_news') }}/{{ $arr->pk_news_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="optionsRadios">Loại tin</label>
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_category_news" id="optionsRadios" value="1" @if($arr->c_category_news ==1 )checked @endif >
                            Tin ATTP trong nước
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_category_news" id="optionsRadios" value="0" @if($arr->c_category_news ==0 )checked @endif >
                            Tin ATTP ngoài nước
                        </label>
                      </div>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ảnh đại diện:</label>
                        ...
                        <img class="img" src="{{ $arr->c_img }}" style="width:30%">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/news')}}"><button type="button" class="btn btn-primary"><i class="fa fa-undo" aria-hidden="true"></i> Trở về</button></a>
                  </div>
                </form>
              </div><!-- /.box -->
