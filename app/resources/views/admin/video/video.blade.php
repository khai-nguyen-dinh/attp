...
?>
		<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Phóng sự/thông điệp</li>
          </ol>
        </section>


        <form method="post" action="{{ url('admin/delete_all_video') }}">
        {!! csrf_field() !!}
        <!-- Main content -->
            ...
            <div class="col-xs-12">
             <div class="box">
                <div class="box-header">
                  ...
                  <br>
                  <br>
                  <a href="{{ url('/admin/add_video')}}"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Thêm</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($list_video as $video)
                      <tr>
                        ...
                        <td ><input name="id[]" type="checkbox" value="{{ $video->pk_video_id }}"/></td>
                        <td>{{ $video->pk_video_id }}</td>
                        <td>{{ $video->c_date }}</td>
                        <td><a href="{{ url('admin/edit_video') }}/{{ $video->pk_video_id }}">{{ $video->c_name }}</a></td>
                       <td>
                          @if($video->c_lang == "en") 
                         ...
                         <td><a style="color:red; font-size:15px"  onClick="javascript:return window.confirm('Bạn muốn xóa bài viết này?');" href="{{ url('admin/delete_video') }}/{{ $video->pk_video_id }}"><i class="fa fa-close"></i></a></td>
                      </tr>
                    @endforeach
                    </tbody>
                    <tfoot>
