...
?>
        ...
        <form method="post" action="{{ url('admin/delete_all_document') }}">
        {!! csrf_field() !!}
        <!-- Main content -->
            ...
            <div class="col-xs-12">
             <div class="box">
                <div class="box-header">
                  ...
                  <br>
                  <br>
                  <a href="{{ url('/admin/add_document')}}"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Thêm</button></a>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($list_document as $document)
                      <tr>
                        <td ><input name="id[]" type="checkbox" value="{{ $document->pk_document_id }}"/></td>
