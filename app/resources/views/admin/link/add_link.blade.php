...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/link')}}">Website liên kết</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_add_link') }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <br>                    
                        ...
                        <img class="img" src="{{ url('public/upload/link')}}/web.jpg" style="width:30%"></a>
