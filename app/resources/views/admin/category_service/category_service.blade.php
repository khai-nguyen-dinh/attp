...
?>
        ...
        <form method="post" action="{{ url('admin/delete_all_category_service') }}">
        {!! csrf_field() !!}
            ...
            <div class="col-xs-12">
             <div class="box">
                <div class="box-header">
                  ...
                  <br>
                  <br>
                  <a href="{{ url('/admin/add_category_service')}}"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Thêm</button></a>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($list_category_service as $category_service)
                      <tr>
                         <td ><input name="id[]" type="checkbox" value="{{ $category_service->pk_category_service_id }}"/></td>
