...
//=======================Admin=========================
	...
	Route::group(array('prefix'=>'admin','middleware'=>'auth'),function(){
			...
			Route::post('/delete_all_category_about','Admin\CategoryAboutController@delete_all_category_about');
			...
			Route::post('/delete_all_about','Admin\AboutController@delete_all_about');
			...
			Route::post('/delete_all_category_service','Admin\CategoryServiceController@delete_all_category_service');
			...
			Route::post('/delete_all_service','Admin\ServiceController@delete_all_service');
			...
			Route::post('/delete_all_category_other','Admin\CategoryOtherController@delete_all_category_other');
			...
			Route::post('/delete_all_other','Admin\OtherController@delete_all_other');
			...
			Route::post('/delete_all_science','Admin\ScienceController@delete_all_science');
			...
			Route::post('/delete_all_news','Admin\NewsController@delete_all_news');
			...
			Route::post('/delete_all_document','Admin\DocumentController@delete_all_document');
			...
			Route::post('/delete_all_video','Admin\VideoController@delete_all_video');
			...
			Route::post('/delete_all_link','Admin\LinkController@delete_all_link');
			...
			Route::post('/delete_all_qa','Admin\QaController@delete_all_qa');
			...
			Route::post('/delete_all_contact','Admin\ContactController@delete_all_contact');
...
Route::get('/{locale}/hoi-dap','MasterController@qa');
Route::post('/{locale}/hoi-dap','MasterController@postQa');
Route::get('/{locale}/lien-he','MasterController@contact');
Route::post('/{locale}/lien-he','MasterController@postContact');
// Route::get('/{locale}/tim-kiem','MasterController@search');
Route::get('/{locale}/tim-kiem','MasterController@search');
