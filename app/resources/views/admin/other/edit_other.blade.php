...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/other')}}">Bài viết dịch vụ khác</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_other') }}/{{ $arr->pk_other_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                  ...
                  <div class="box-body">
                      ...
                      <input type="text" class="form-control" id="c_name" required name="c_name" value="<?php if(isset($arr->c_name)) echo $arr->c_name ?>" placeholder="Tiêu đề bài viết">
	                    ...
	                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fk_category_other_id">
	                      <?php 

	                      

	                      $cat = DB::table("tbl_category_other")->where("c_lang","=",$c_lang)->get(); 
	                      
	                      foreach($cat as $rows){
	                      	
	                      	 
	                      	if($arr->fk_category_other_id == $rows->pk_category_other_id){ ?>
	                      <option value="{{ $rows->pk_category_other_id }}" selected >{{ $rows->c_name }}</option>
	                      <?php }else { ?>

	                       <option value="{{ $rows->pk_category_other_id }}" >{{ $rows->c_name }}</option>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ảnh đại diện:</label>
                     	...
                     	<br>Ảnh đại diện cũ:
                     	<br><img src="{{ url('public/upload/other') }}/<?php if(isset($arr->c_img)) echo $arr->c_img ?>" style="width:30%">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/other')}}"><button type="button" class="btn btn-primary"><i class="fa fa-undo" aria-hidden="true"></i> Trở về</button></a>
                  </div>
                </form>
              </div><!-- /.box -->
