          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_service') }}/{{ $arr->pk_service_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                      ...
                      <input type="text" class="form-control" id="c_name" required name="c_name" value="<?php if(isset($arr->c_name)) echo $arr->c_name ?>" placeholder="Tiêu đề bài viết">
	                    ...
	                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fk_category_service_id">
	                      ...
	                      foreach($cat as $rows){
	                      	...
	                      	if($arr->fk_category_service_id == $rows->pk_category_service_id){ ?>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ảnh đại diện:</label>
                     	...
                     	<br>Ảnh đại diện cũ:
                     	<br><img src="{{ url('public/upload/service') }}/<?php if(isset($arr->c_img)) echo $arr->c_img ?>" style="width:30%">
