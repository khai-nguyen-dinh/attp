...
?>
		<section class="content-header">
         ...
         <form method="post" action="{{ url('admin/delete_all_science') }}">
        {!! csrf_field() !!}
        <!-- Main content -->
            ...
            <div class="col-xs-12">
             <div class="box">
                <div class="box-header">
                  ...
                  <br>
                  <br>
                  <a href="{{ url('/admin/add_science')}}"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Thêm</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($list_science as $science)
                      <tr>
                        ...
                        <td ><input name="id[]" type="checkbox" value="{{ $science->pk_science_id }}"/></td>
