...
class CategoryAboutController extends Controller{
	...
	public function delete_all_category_about(){
		
		$id=Request::get("id");
		foreach ($id as $category_about_id) {
			DB::delete("delete from tbl_category_about where pk_category_about_id=$category_about_id");
		}
		return redirect("/admin/category_about");
	}
}