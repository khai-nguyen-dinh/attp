...
?>
        ...
        <form method="post" action="{{ url('admin/delete_all_link') }}">
        {!! csrf_field() !!}
        <!-- Main content -->
            ...
            <div class="col-xs-12">
             <div class="box">
                <div class="box-header">
                  ...
                  <br>
                  <br>
                  <a href="{{ url('/admin/add_link')}}"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Thêm</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($list_link as $link)
                      <tr>
                        ...
                        <td ><input name="id[]" type="checkbox" value="{{ $link->pk_link_id }}"/></td>
